...
var StudentManager = {
    ...
    studentDetailUpdate: function (studentId, phone, phone2, qq, email, address, callback) {
        ajaxGet("/Ashx/StudentDetailUpdate.ashx", {
            studentId: studentId,
            phone: phone,
            phone2: phone2,
            qq: qq,
...
var StudentCompain = {
    insertCompain: function (studentId, Ctitle, Ctype, Ccontent, callback) {
        ajaxGet("/Ashx/InsertStudentCompain.ashx", {
            studentId: studentId,
            Ctitle: Ctitle,
            Ctype: Ctype,
            Ccontent: Ccontent
...
var studentInfo = {
    ...
    insertStudentLetterDetail: function (lid, detail, descript, callback) {
        ...
        ajaxGet("/User/StudentInfor/Ashx/InsertStudentLetterDetail.ashx", {
            lid: lid,
            detail: detail,
            descript: descript
        }, callback);
...
var senateCenter = {
    modifyStudentScoreStatus: function (sid, examtime, stype, callback) {
        ajaxGet("/User/SenateCenter/Ashx/ModifyStudentScoreStatus.ashx", {
            sid: sid,
            examtime: examtime,
            stype: stype
        }, callback);
