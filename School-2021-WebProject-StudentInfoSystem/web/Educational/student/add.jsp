    ...
    <form action="/Educational/student/addStudent" method="post">
        <table border="1" width="100%" class="table_a">
            ...
            <tr width="120px;">
                ...
                <td>
                    <input type="text" name="stuName" value="XXX"/>
                </td>
            </tr>
            ...
            <tr>
                <td>EMAIL：</td>
                <td>
                    <input type="text" name="email" value="name@address.com"/>
                </td>
            </tr>
            ...
            <tr>
                <td>专业：</td>
                <td>
                    <input type="text" name="profession" value="xxx"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="introduction">介绍的内容：</textarea>
                </td>
            </tr>
            <tr>
